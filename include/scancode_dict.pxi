...
cdef object scancodes = {
    SDLK_UNKNOWN : SDL_SCANCODE_UNKNOWN,
    ...
    SDLK_COMMA : SDL_SCANCODE_COMMA,
    SDLK_MINUS : SDL_SCANCODE_MINUS,
    SDLK_PERIOD : SDL_SCANCODE_PERIOD,
    SDLK_SLASH : SDL_SCANCODE_SLASH,
    SDLK_0 : SDL_SCANCODE_0,
    SDLK_1 : SDL_SCANCODE_1,
    SDLK_2 : SDL_SCANCODE_2,
    SDLK_3 : SDL_SCANCODE_3,
    SDLK_4 : SDL_SCANCODE_4,
    SDLK_5 : SDL_SCANCODE_5,
    SDLK_6 : SDL_SCANCODE_6,
    SDLK_7 : SDL_SCANCODE_7,
    SDLK_8 : SDL_SCANCODE_8,
    SDLK_9 : SDL_SCANCODE_9,
    SDLK_SEMICOLON : SDL_SCANCODE_SEMICOLON,
    SDLK_EQUALS : SDL_SCANCODE_EQUALS,
    SDLK_LEFTBRACKET : SDL_SCANCODE_LEFTBRACKET,
    SDLK_BACKSLASH : SDL_SCANCODE_BACKSLASH,
    SDLK_RIGHTBRACKET : SDL_SCANCODE_RIGHTBRACKET,
    SDLK_a : SDL_SCANCODE_A,
    SDLK_b : SDL_SCANCODE_B,
    SDLK_c : SDL_SCANCODE_C,
    SDLK_d : SDL_SCANCODE_D,
    SDLK_e : SDL_SCANCODE_E,
    SDLK_f : SDL_SCANCODE_F,
    SDLK_g : SDL_SCANCODE_G,
    SDLK_h : SDL_SCANCODE_H,
    SDLK_i : SDL_SCANCODE_I,
    SDLK_j : SDL_SCANCODE_J,
    SDLK_k : SDL_SCANCODE_K,
    SDLK_l : SDL_SCANCODE_L,
    SDLK_m : SDL_SCANCODE_M,
    SDLK_n : SDL_SCANCODE_N,
    SDLK_o : SDL_SCANCODE_O,
    SDLK_p : SDL_SCANCODE_P,
    SDLK_q : SDL_SCANCODE_Q,
    SDLK_r : SDL_SCANCODE_R,
    SDLK_s : SDL_SCANCODE_S,
    SDLK_t : SDL_SCANCODE_T,
    SDLK_u : SDL_SCANCODE_U,
    SDLK_v : SDL_SCANCODE_V,
    SDLK_w : SDL_SCANCODE_W,
    SDLK_x : SDL_SCANCODE_X,
    SDLK_y : SDL_SCANCODE_Y,
    SDLK_z : SDL_SCANCODE_Z,
